...
class WorlStatesModel {
  ...
  WorlStatesModel.fromJson(dynamic json) {
...
WorlStatesModel copyWith({  num? updated,
  num? cases,
  num? todayCases,
  num? deaths,
  num? todayDeaths,
  ...
  num? criticalPerOneMillion,
  num? affectedCountries,
}) => WorlStatesModel(  updated: updated ?? _updated,
  cases: cases ?? _cases,
